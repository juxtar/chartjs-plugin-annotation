...
Chart.Annotation.types = {
	...
	marker: require('./types/marker.js')(Chart)
};
/* eslint-enable global-require */
...
},{"./annotation.js":2,"./element.js":3,"./types/box.js":7,"./types/line.js":8,"./types/marker.js":9,"chart.js":1}],7:[function(require,module,exports){
...
module.exports = function(Chart) {
	...
	var MarkerAnnotation = Chart.Annotation.Element.extend({
		setDataLimits: function() {
			var model = this._model;
			var options = this.options;
			var chartInstance = this.chartInstance;
